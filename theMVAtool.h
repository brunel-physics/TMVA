...
public :
   ...
   void doTraining(TString indir = "inputroot/met0mtw0", TString channel = "all");
   void doReading(TString indir = "inputroot/met0mtw0", TString outDir = "outputroot/", TString channel = "all", float bdtcut = 100.);
